    ...
    var that = {
      ...
      redraw:function(){
        ...
        particleSystem.eachNode(function(node, pt){
          ...
          */
          ...
          if (node.data.shape=='dot'){
            ...
            var thumb = new Image()
            thumb.src = node.data.url
            ctx.drawImage(thumb, pt.x-w/2, pt.y-w/2)
            nodeBoxes[node.name] = [pt.x-w/2, pt.y-w/2-1, w, w+25]
          }
          ...
          if (label){
            ...
            ctx.fillText(label||"", pt.x, pt.y+40)
            ctx.fillText(label||"", pt.x, pt.y+40)
          }
        ...
        particleSystem.eachEdge(function(edge, pt1, pt2){
          ...
          var showAll = $("#all").prop('checked');
          var hovered = edge.source.data.hovered=='y'||edge.target.data.hovered=='y'
          if(showAll || hovered){
              var weight = 1
              var color = '#8181F7'
        ...
        var handler = {
          moved:function(e){
            ...
            if(selected){
                ...
                particleSystem.tweenNode(nearest.node, 0, {hovered:'y'})
            } else {
